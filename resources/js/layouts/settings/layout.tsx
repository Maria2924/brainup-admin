...
const instructorSidebarNavItems: NavItem[] = [
    {
        title: 'Profile',
        href: '/instructor/settings/profile',
        icon: null,
    },
    {
        title: 'Password',
    ...
    {
        title: 'Appearance',
        href: '/instructor/settings/appearance',
        icon: null,
    },
];
            ...
            <div className="flex flex-col space-y-8 lg:flex-row lg:space-y-0 lg:space-x-12">
                <aside className="w-full max-w-xl lg:w-48">
                    <nav className="flex flex-col space-y-1 space-x-0">
                        {auth.user.role === 'admin' ? sidebarNavItems.map((item, index) => (
                            <Button
                                key={`${item.href}-${index}`}
                                size="sm"
                                variant="ghost"
